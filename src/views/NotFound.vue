	...
	<main class="grey lighten">
		<div class="container">
			<div class="row center-align white-text">
				<svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="206.5px" viewBox="0 0 326.5 500"
					style="enable-background:new 0 0 326.5 500;" xml:space="preserve">
					<g id="robot_1_">
				...
				<h1>404</h1>
				<h3>ERROR PAGE</h3>
				<a class="white-text" href="/">Back to Home</a>
			</div>
		</div>
	</main>
</template>
